...
public class Board extends JPanel implements ActionListener, KeyListener {
    ...
    public static final int NUM_ENEMIES = 2;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // kill the player for collecting enemy
        collectEnemies();
    ...
    private ArrayList<Enemy> populateEnemies() {
        ...
        // note that there is not check here to prevent two enemies from occupying the
        // same
    ...
    private void collectEnemies() {
        // allow player to pickup enemies
        ArrayList<Enemy> collectedEnemies = new ArrayList<>();
        for (Enemy enemy : enemies) {
            // if the player is on the same tile as enemy, collect it
        ...
        // remove collected enemies from the board
        enemies.removeAll(collectedEnemies);
    }
